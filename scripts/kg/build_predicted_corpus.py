...
POOL = "/scratch/user/acm_data/organ_pool_lkp"
TPOOL = "/scratch/user/acm_data/tumor_pool"
DEV = "cuda:0"
...
def main():
    ...
    fp = f"/home/user/SWOG/results/corpus_{'gt' if a.gt else 'predicted'}_{a.dataset}.json"
