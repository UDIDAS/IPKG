...
POOLS = {"tumor_pool": "/scratch/user/acm_data/tumor_pool",           # LiTS + Pancreas
         "flare_tumor_pool": "/scratch/user/acm_data/flare_tumor_pool",
         "kits_tumor_pool": "/scratch/user/acm_data/kits_tumor_pool"}
CKPT_DIR = "/scratch/user/acm_data/tumor_pool"
KG = "--kg" in sys.argv                                  # KG-in-training size-plausibility loss on/off (ablation)
TAG = "_kg" if KG else ""
OUT = f"/home/user/SWOG/results/tumor_incremental{TAG}.json"
