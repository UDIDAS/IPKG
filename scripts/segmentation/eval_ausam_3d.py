...
FT2 = "/scratch/user/acm_data/FLARE_Task2"
import glob
import os
...
FFC = "/scratch/user/acm_data/flare_full_cases"   # FLARE23 full volumes (local subset)
...
def main():
    ...
    fp = f"/home/user/SWOG/results/ausam_3d_{a.dataset}.json"
