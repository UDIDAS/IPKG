...
TUMOR_LABEL = 14
DEF_ORGAN = "/scratch/user/acm_data/organ_pool_lkp/sam3_organ_generic.pth"
DEF_TUMOR = "/scratch/user/acm_data/tumor_pool/sam3_tumor_generic.pth"
...
def reconstruct(ct_path, out_dir, organ_ckpt, tumor_ckpt, use_kg=True):
    ...
    if use_kg:
        try:
            ...
            import json
            atlas = json.load(open("/home/user/SWOG/kg/data/kg_atlas.json"))
